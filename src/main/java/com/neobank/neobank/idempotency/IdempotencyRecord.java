...
public class IdempotencyRecord extends BaseEntity {
    ...
    public static IdempotencyRecord createNew(
            ...
            @NonNull String resultReference
    ) {
        ...
        if(!resultReference.matches("[0-9a-f]{32}")) {
            throw new IllegalArgumentException("Result reference must contain only hex characters [a-f, 0-9] and be exactly 32 characters long");
        }
